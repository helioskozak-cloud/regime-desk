...
_SECTOR_MAP = {
    ...
    'ACHR': 'Defense', 'ACI': 'Consumer Staples', 'ACM': 'Industrials',
    ...
    'AKAM': 'Technology', 'ALAB': 'Semiconductors', 'ALB': 'Materials',
    ...
    'APLD': 'Technology', 'APO': 'Financials', 'APP': 'Communication Services',
    ...
    'BEN': 'Financials', 'BF-B': 'Consumer Staples', 'BFAM': 'Consumer Discretionary',
    'BFH': 'Financials', 'BG': 'Consumer Staples', 'BHF': 'Financials', 'BIIB': 'Healthcare',
    'BILL': 'Technology', 'BIO': 'Healthcare', 'BIRK': 'Consumer Discretionary', 'BITB': 'Crypto', 'BITO': 'Crypto', 'BITU': 'Crypto', 'BITX': 'Crypto',
    'BJ': 'Consumer Staples', 'BKH': 'Energy', 'BKNG': 'Consumer Discretionary',
    'BKR': 'Energy', 'BLDR': 'Industrials', 'BLK': 'Financials',
    ...
    'CFG': 'Financials', 'CFR': 'Financials', 'CG': 'Financials',
    ...
    'CSIQ': 'Energy Transition', 'CSL': 'Industrials', 'CSX': 'Industrials', 'CTAS': 'Industrials', 'CTRE': 'Real Estate', 'CTSH': 'Technology', 'CTVA': 'Materials',
    'CUBE': 'Real Estate', 'CVCO': 'Consumer Discretionary', 'CVE': 'Energy',
    'CVLT': 'Technology', 'CVNA': 'Consumer Discretionary', 'CVS': 'Healthcare', 'CVX': 'Energy',
    'CW': 'Industrials', 'CWST': 'Industrials', 'CX': 'Materials',
    ...
    'EIX': 'Utilities', 'EL': 'Consumer Staples', 'ELAN': 'Healthcare',
    ...
    'EW': 'Healthcare', 'EWBC': 'Financials', 'EXC': 'Utilities',
    ...
    'FND': 'Consumer Discretionary', 'FNF': 'Financials', 'FNV': 'Materials',
    ...
    'GS': 'Materials', 'GSLC': 'Materials', 'GTLB': 'Technology',
    ...
    'HLT': 'Consumer Discretionary', 'HMY': 'Materials', 'HOG': 'Consumer Discretionary',
    ...
    'JDST': 'Materials', 'JEF': 'Financials', 'JHX': 'Materials',
    ...
    'MARA': 'Financials', 'MAS': 'Industrials', 'MAT': 'Consumer Discretionary',
    ...
    'NET': 'Technology', 'NEU': 'Materials', 'NFG': 'Energy', 'NFLX': 'Communication Services', 'NI': 'Utilities', 'NKE': 'Consumer Discretionary', 'NLY': 'Real Estate',
    ...
    'NUE': 'Materials', 'NUGT': 'Materials', 'NVDA': 'Technology',
    ...
    'ORCL': 'Technology', 'ORI': 'Financials', 'ORLY': 'Consumer Discretionary',
    ...
    'PSKY': 'Communication Services', 'PSLV': 'Materials', 'PSN': 'Technology',
    ...
    'SANM': 'Technology', 'SAP': 'Technology', 'SARO': 'Industrials',
    ...
    'SEB': 'Industrials', 'SEDG': 'Energy Transition', 'SEI': 'Energy Transition',
    ...
    'SITM': 'Technology', 'SIVR': 'Materials', 'SJM': 'Consumer Staples', 'SKY': 'Consumer Discretionary', 'SLB': 'Energy', 'SLM': 'Financials',
    ...
    'TER': 'Technology', 'TEX': 'Industrials', 'TFC': 'Financials',
    ...
    'VEEV': 'Healthcare', 'VERA': 'Biotech', 'VFC': 'Consumer Discretionary',
    ...
    'VSAT': 'Technology', 'VSEC': 'Industrials', 'VSNT': 'Communication Services',
